...
function createCoordinateArray(feature) {
    //Loop through the coordinates and figure out if the points need
    //interpolation.
    var temp_array = [];
    ...
    for (var point_num = 0; point_num < feature.length; point_num++) {
        ...
        if (point_num > 0) {
            if (needsInterpolation(point2, point1)) {
                interpolation_array = interpolatePoints([point2, point1]);

                for (var inter_point_num = 0;
